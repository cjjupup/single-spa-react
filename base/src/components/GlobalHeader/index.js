...
export default class GlobalHeader extends PureComponent {
  ...
  render() {
    ...
    return (
      <div className={style['globl-header']}>
        {isMobile && [
        ...
        <div className={style.right}>
          ...
          {/* <Tooltip title="使用文档">
            <a
              target="_blank"
              href="http://pro.ant.design/docs/getting-started-cn"
          ...
          {currentUser.name ? (
            <Dropdown overlay={menu}>
              <span className={`${style.action} ${style.account}`}>
                <Avatar size="small" className={style.avatar} icon="user" />
        ...
        <SelectLang className={style.action} {...this.props}/>
        </div>
      </div>
    );
  }
