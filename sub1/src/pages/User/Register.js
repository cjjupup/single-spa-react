...
const passwordStatusMap = {
  ok: <div className={style.success}>强度：强</div>,
  pass: <div className={style.warning}>强度：中</div>,
  poor: <div className={style.error}>强度：太短</div>,
}
...
export default class Register extends Component {
  ...
  render() {
    ...
    return (
      <div className={style['main-register']}>
        <h3>注册</h3>
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem>
            ...
            <Link className={style.login} to='/user/login'>
              使用已有账户登录
            </Link>
          </FormItem>
        </Form>
